...
namespace GUI
{
    public partial class frmQuanLySach : Form
    {
        ...
        private void dgvSach_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtDuocBan.Text = dgvSach.Rows[dong].Cells[7].Value.ToString();
        }
        ...
        private void btnDuocBan_Click(object sender, EventArgs e)
        {
            Sach_DTO s = new Sach_DTO();
            s.DuocBan = 1;
            s.MaSach = int.Parse(txtMaSach.Text);
            txtDuocBan.Text = "1";
            MessageBox.Show("Sách này sẽ được bán", "Thông báo", MessageBoxButtons.OK);
            Sach_BUS.DuocBan(s);
            HienThiThongTinSach();
        }

        private void btnKhongDuocBan_Click(object sender, EventArgs e)
        {
            Sach_DTO s = new Sach_DTO();
            s.DuocBan = 0;
            s.MaSach = int.Parse(txtMaSach.Text);
            txtDuocBan.Text = "0";
            MessageBox.Show("Sách này sẽ không được bán", "Thông báo", MessageBoxButtons.OK);
            Sach_BUS.DuocBan(s);
            HienThiThongTinSach();
        }
